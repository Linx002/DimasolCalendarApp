...
<div class="dimasol-row-padding dimasol-light-grey dimasol-padding-64 dimasol-container">
    <div class="dimasol-third dimasol-container" id="contact">
        <h2>Contacto</h2>
        ...
        <form action="mailto:linx002xbox@gmail.com" method="GET">
            <p><input class="dimasol-input dimasol-padding-16 dimasol-border" type="text" placeholder="Nombre" required name="subject"></p>
            <p><input class="dimasol-input dimasol-padding-16 dimasol-border" type="text" placeholder="Correo Electrónico" required name="cc"></p>
            <p><input class="dimasol-input dimasol-padding-16 dimasol-border" type="text" placeholder="Mensaje" required name="body"></p>
